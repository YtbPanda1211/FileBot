...
module.exports.config = {
	...
	usages: "prefix+datlich Nội dung | ngày/tháng/năm_giờ:phút:giây", // Cách sử dụng lệnh
...
module.exports.run = async function ({ api, event, args, Users }) {
	...
	// CHECK CHECK CHECK
	if (date[0].split("/").length != 3 || date[1].split(":").length != 3) return api.sendMessage("Bạn phải dùng đúng nội dung!, Mẫu:prefix+datlich Nội dung | ngày/tháng/năm_giờ:phút:giây", threadID, messageID);
